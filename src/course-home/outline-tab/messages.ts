...
const messages = defineMessages({
  allDates: {
    ...
    defaultMessage: 'Xem tất cả các ngày học trong khóa',
  ...
  hiddenSection: {
    ...
    defaultMessage: 'Ẩn trong mục lục khóa học, truy cập qua liên kết',
    description: 'Label for hidden section in course outline',
  },
  hiddenSequenceLink: {
    id: 'learning.outline.hiddenSequenceLink',
    defaultMessage: 'Các phần nhỏ không thể chuyển qua lại, chỉ truy cập qua liên kết.',
  ...
  goalReminderDetail: {
    ...
    defaultMessage: 'Nếu bạn chưa đạt mục tiêu, chúng tôi sẽ gửi email nhắc nhở.',
  ...
  setGoal: {
    ...
    defaultMessage: 'Để bắt đầu, hãy đặt mục tiêu học tập bằng cách chọn phương án phù hợp bên dưới.',
  ...
  setLearningGoalButtonScreenReaderText: {
    ...
    defaultMessage: 'Chọn kiểu mục tiêu học tập.',
  ...
  startBlurb: {
    ...
    defaultMessage: 'Bắt đầu học ngay hôm nay',
  },
  tools: {
  ...
  upgradeTitle: {
    ...
    defaultMessage: 'Nhận chứng chỉ xác thực',
  ...
  otherCourseApprovedProctoringStatus: {
    ...
    defaultMessage: 'Đã xác thực ở khóa học khác',
  ...
  verifiedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra onboarding của bạn đã được xác thực ở khóa học này.',
  ...
  errorProctoringMessage: {
    ...
    defaultMessage: 'Đã xảy ra lỗi trong quá trình kiểm tra onboarding. Vui lòng thử lại.',
  ...
  otherCourseApprovedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra onboarding của bạn đã được xác thực ở khóa học khác.',
  ...
  otherCourseApprovedProctoringDetail: {
    ...
    defaultMessage: 'Nếu thiết bị của bạn đã thay đổi, hãy hoàn thành lại bài kiểm tra onboarding để đảm bảo đáp ứng yêu cầu.',
  ...
  expiringSoonProctoringMessage: {
    ...
    defaultMessage: 'Hồ sơ onboarding của bạn đã được xác thực. Tuy nhiên, trạng thái onboarding sắp hết hạn. Vui lòng hoàn thành lại để tiếp tục làm bài kiểm tra giám sát.',
  ...
  expiredProctoringMessage: {
    ...
    defaultMessage: 'Trạng thái onboarding của bạn đã hết hạn. Vui lòng hoàn thành lại để tiếp tục làm bài kiểm tra giám sát.',
  ...
  proctoringPanelGeneralInfo: {
    ...
    defaultMessage: 'Bạn phải hoàn thành onboarding trước khi làm bài kiểm tra giám sát.',
  ...
  proctoringOnboardingButtonNotOpen: {
    ...
    defaultMessage: 'Onboarding mở vào: {releaseDate}',
  ...
  sequenceDueDate: {
    ...
    defaultMessage: '{description} hạn {assignmentDue}',
